...
service_rate_L1 = total_groups * total_flows_per_group * source_rate
service_rate_L2 = total_flows_per_group * source_rate
...
ps = PacketSink(env)
drr_server = DRRServer(env, service_rate_L1, group_weights, zero_buffer=True)
drr_server.out = ps
