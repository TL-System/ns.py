...
from packet.dist_generator import PacketDistGenerator
from packet.sink import PacketSink
from switch.switch import SimplePacketSwitch
from topos.fattree import build as build_fattree
from topos.utils import generate_fib, generate_flows
...
if __name__ == "__main__":
  ...
  for fid in all_flows:
    ...
    pg = PacketDistGenerator(env, f"Flow_{fid}", arr_dist, size_dist, flow_id=fid)
    ps = PacketSink(env, rec_arrivals=True, absolute_arrivals=True, debug=False)
